  ...
  return (
    <Screen preset="scroll" contentContainerStyle={themed($screenContent)}>
      ...
      <View style={StyleSheet.absoluteFill}>
        <LinearGradient
          colors={
            theme.isDark ? ['#0a0a0a', '#1a1a1a'] : ['#fafaf9', '#f5f5f4']
          }
            ...
            <View style={themed($statusLeft)}>
              <View style={themed($statusIndicator)}>
                ...
                <Text
                  ...
                  tx="home:status.allNormal"
                />
              </View>
              <Text
                preset="formHelper"
                style={themed($statusTime)}
                tx="home:status.lastUpdated"
              />
            </View>
            <IconContainer
