...
const locationSlice = createSlice({
  ...
  reducers: {
    // Permission actions
    setPermissionStatus: (state, action: PayloadAction<{
      hasPermission: boolean;
    ...
    updateCurrentLocation: (state, action: PayloadAction<Location.LocationObject>) => {
    ...
    initializeFromService: (state, action: PayloadAction<{
      hasPermission: boolean;
      isTracking: boolean;
