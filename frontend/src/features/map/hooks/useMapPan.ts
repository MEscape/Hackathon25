        ...
        () =>
            PanResponder.create({
                ...
                onPanResponderMove: (_, gestureState) => {
                    ...
                    const tileShiftX = Math.floor((newOffsetX + (newOffsetX > 0 ? threshold : -threshold)) / displayTileSize);
                    const tileShiftY = Math.floor((newOffsetY + (newOffsetY > 0 ? threshold : -threshold)) / displayTileSize);
