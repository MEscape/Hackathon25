...
import type {DiscoverableUser, EmergencyContact} from "../schemas/emergency.schema";
...
export const emergencyContactsSlice = createSlice({
    ...
    reducers: {
        ...
        setDiscoverableUsers: (state, action: PayloadAction<DiscoverableUser[]>) => {
...
// Base Selectors
export const selectEmergencyContacts = (state: { emergencyContacts: EmergencyContactsState }) =>
    state.emergencyContacts.contacts;

export const selectDiscoverableUsers = (state: { emergencyContacts: EmergencyContactsState }) =>
    state.emergencyContacts.discoverableUsers;

export const selectEmergencyContactsLoading = (state: { emergencyContacts: EmergencyContactsState }) =>
    state.emergencyContacts.isLoading;

export const selectEmergencyContactsError = (state: { emergencyContacts: EmergencyContactsState }) =>
