    ...
    endpoints: builder => ({
        ...
        getEmergencyContacts: builder.query<EmergencyContact[], void>({
            ...
            transformResponse: (response: unknown) => {
                const validated = validateApiResponse(EmergencyContactsResponseSchema, response);
        ...
        getDiscoverableUsers: builder.query<DiscoverableUser[], void>({
            ...
            transformResponse: (response: unknown) => {
                const validated = validateApiResponse(DiscoverableUsersResponseSchema, response);
        ...
        sendFriendRequest: builder.mutation<FriendRequestResponse, string>({
            ...
            async onQueryStarted(userId, { dispatch, queryFulfilled }) {
                ...
                const patchResult = dispatch(
                    emergencyContactsApi.util.updateQueryData('getDiscoverableUsers', undefined, (draft) => {
        ...
        removeEmergencyContact: builder.mutation<FriendRequestResponse, string>({
            ...
            async onQueryStarted(userId, { dispatch, queryFulfilled }) {
                ...
                const contactsPatchResult = dispatch(
                    emergencyContactsApi.util.updateQueryData('getEmergencyContacts', undefined, (draft) => {
