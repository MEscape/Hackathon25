...
export function EmergencyContactsScreen() {
  ...
  const handleSendRequest = async (id: string) => {
    ...
    if (result.success) {
      Toast.show({
        type: 'success',
        text1: translate('emergencyContacts:toasts.friendRequestSent'),
      });
    } else {
      Toast.show({
        type: 'error',
        text1: translate('emergencyContacts:toasts.friendRequestSentError'),
        text2: result.error,
      });
    }
  };
  ...
  const handleAcceptRequest = async (id: string) => {
    ...
    if (result.success) {
      Toast.show({
        type: 'success',
        text1: translate('emergencyContacts:toasts.friendRequestAccepted'),
      });
    } else {
      Toast.show({
        type: 'error',
        text1: translate('emergencyContacts:toasts.friendRequestAcceptError'),
        text2: result.error,
      });
    }
  };
  ...
  const handleDeclineRequest = async (id: string) => {
    ...
    if (result.success) {
      Toast.show({
        type: 'success',
        text1: translate('emergencyContacts:toasts.friendRequestDeclined'),
      });
    } else {
      Toast.show({
        type: 'error',
        text1: translate('emergencyContacts:toasts.friendRequestDeclineError'),
        text2: result.error,
      });
    }
  };
  ...
  const handleRemoveContact = async (id: string) => {
    ...
    if (result.success) {
      Toast.show({
        type: 'success',
        text1: translate('emergencyContacts:toasts.contactRemoved'),
      });
    } else {
      Toast.show({
        type: 'error',
        text1: translate('emergencyContacts:toasts.contactRemoveError'),
        text2: result.error,
      });
    }
  };
