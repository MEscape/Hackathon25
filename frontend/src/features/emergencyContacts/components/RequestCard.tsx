        ...
        <View style={themed($card)}>
            <View style={themed($content)}>
                ...
                <View style={themed($avatarContainer)}>
                    <View style={[themed($avatar), { backgroundColor: getAvatarColor(request.username) }]}>
                        <Text style={themed($avatarText)}>{request.username.charAt(0).toUpperCase()}</Text>
                    </View>
                ...
                <View style={themed($info)}>
                    <Text style={themed($name)} numberOfLines={1}>{request.username}</Text>
                    <Text style={themed($email)} numberOfLines={1}>{request.email}</Text>
