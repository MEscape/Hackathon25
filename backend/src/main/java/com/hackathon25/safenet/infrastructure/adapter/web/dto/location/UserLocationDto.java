 ...
 *
 * <p>This DTO represents user location information returned by the API, including coordinates,
 * accuracy, visibility settings, and timestamps.
 */
@Data
@Builder
...
public class UserLocationDto {
  ...
  @Schema(
      description = "Timestamp when the location was first recorded",
  ...
  @Schema(
      description = "Whether the location was updated recently (within 5 minutes)",
      example = "true")
