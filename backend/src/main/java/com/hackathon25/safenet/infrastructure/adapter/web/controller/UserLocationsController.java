 ...
 *
 * <p>This controller handles location queries and updates, combining previous
 * retrieval and update operations into a single REST adapter.</p>
 *
 * <h3>Supported Operations</h3>
 * <ul>
 *   <li>Get Friends' Locations</li>
 *   <li>Get Friend Location</li>
 *   <li>Update Location</li>
 *   <li>Update Visibility</li>
 * </ul>
 *
...
public class UserLocationsController {
    ...
    public ResponseEntity<UserLocationDto> updateLocation(
            @Valid @RequestBody UpdateLocationDto locationUpdate,
        ...
        UserLocation updated = updateUserLocationPort.updateLocation(
                userId,
