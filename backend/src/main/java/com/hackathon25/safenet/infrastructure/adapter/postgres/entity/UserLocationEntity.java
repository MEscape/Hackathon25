...
/**
 * JPA Entity for User Location table Maps to the 'user_locations' table in PostgreSQL/Supabase.
 * Represents real-time user location data with visibility controls. Features: - UUID primary key
 * with auto-generation - Foreign key relationship to UserEntity - Latitude/Longitude coordinates
 * with precision - Visibility flag for privacy control - Automatic timestamp management - Accuracy
...
public class UserLocationEntity {
  ...
  /**
   * User whose location this represents One-to-one relationship as each user has only one current
   * location
   */
  ...
  /** Latitude coordinate Range: -90.0 to 90.0 degrees */
  ...
  /** Longitude coordinate Range: -180.0 to 180.0 degrees */
  ...
  /**
   * Whether this location is visible to friends If false, location is still stored but not shared
   * with friends
   */
  ...
  public boolean isRecent() {
    return updatedAt != null && updatedAt.isAfter(Instant.now().minusSeconds(300)); // 5 minutes
  }
}
