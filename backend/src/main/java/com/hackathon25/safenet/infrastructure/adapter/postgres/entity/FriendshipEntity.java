...
/**
 * JPA Entity for Friendship table Maps to the 'friendships' table in PostgreSQL/Supabase.
 * Represents accepted friend relationships between users. Features: - UUID primary key with
 * auto-generation - Foreign key relationships to UserEntity - Bidirectional friendship
 * representation - Automatic timestamp management - Unique constraint to prevent duplicate
 * friendships
 */
@Entity
@Table(
...
public class FriendshipEntity {
  ...
  /** Record creation timestamp Automatically set when friendship is created */
