...
/**
 * JPA Entity for Friend Request table Maps to the 'friend_requests' table in PostgreSQL/Supabase.
 * Represents friend requests between users with status tracking. Features: - UUID primary key with
 * auto-generation - Foreign key relationships to UserEntity - Status tracking (PENDING, ACCEPTED,
 * REJECTED) - Automatic timestamp management - Unique constraint to prevent duplicate requests
 */
@Entity
@Table(
