 ...
 *
 * <p>This exception is thrown when a user tries to send a friend request to someone they are
 * already friends with, or when attempting to create a duplicate friendship relationship.
 *
