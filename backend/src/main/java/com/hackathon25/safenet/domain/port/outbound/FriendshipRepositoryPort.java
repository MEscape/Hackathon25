 ...
 *
 * <p>This interface defines the operations required to persist and query friendships between users.
 * It abstracts the infrastructure layer (JPA, database, etc.) from the domain and application
 * layers.
 */
