...
/**
 * Domain model representing a discoverable user with friend request status and mutual friends count.
 * This is a pure domain object that encapsulates the business concept of a user that can be discovered
 * by other users in the emergency contacts feature.
 *
