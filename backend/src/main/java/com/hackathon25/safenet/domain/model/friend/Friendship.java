...
/**
 * Immutable domain model representing a friendship between two users. Contains validation logic and
 * business rules for friendships.
 */
public record Friendship(UUID id, UUID user1Id, UUID user2Id, Instant createdAt) {
  ...
  public boolean isRecent() {
    return createdAt != null && createdAt.isAfter(Instant.now().minusSeconds(3600)); // 1 hour
  }
