 ...
 *
 * <p>This exception serves as the parent class for all friendship-specific exceptions in the
 * SafeNet application. It provides a consistent error handling mechanism for friendship operations.
 *
