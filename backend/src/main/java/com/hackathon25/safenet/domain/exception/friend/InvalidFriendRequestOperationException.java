 ...
 *
 * <p>This exception is thrown when a user tries to perform an operation that is not allowed given
 * the current state of the friend request, such as accepting their own request or operating on a
 * request with an invalid status.
 *
...
public class InvalidFriendRequestOperationException extends FriendshipException {
  ...
  public InvalidFriendRequestOperationException() {
    super("error.friend_request.invalid_operation");
  }
}
