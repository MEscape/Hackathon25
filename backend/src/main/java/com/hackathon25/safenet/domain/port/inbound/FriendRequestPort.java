...
public interface FriendRequestPort {
   ...
   * @throws com.hackathon.safenet.domain.exception.user.UserNotFoundException if either user does
   *     not exist
   * @throws com.hackathon.safenet.domain.exception.friend.SelfFriendRequestException if users are
   *     the same
   * @throws com.hackathon.safenet.domain.exception.friend.AlreadyFriendsException if users are
   *     already friends
   * @throws com.hackathon.safenet.domain.exception.friend.DuplicateFriendRequestException if
   ...
   * @throws com.hackathon.safenet.domain.exception.friend.FriendRequestNotFoundException if request
   *     not found
   * @throws com.hackathon.safenet.domain.exception.friend.UnauthorizedFriendRequestActionException
   *     if user not authorized
   * @throws com.hackathon.safenet.domain.exception.friend.InvalidFriendRequestStatusException if
