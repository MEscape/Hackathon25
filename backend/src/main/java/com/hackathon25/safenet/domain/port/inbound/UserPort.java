 ...
 * for managing users and user discovery functionality.</p>
 *
...
public interface UserPort {
    ...
    /**
     * Get discoverable users for a given user.
     * This includes all users except the current user, with their friend request status
     * and mutual friends count.
     *
