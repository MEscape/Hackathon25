 ...
 *
 * <p>This exception is thrown when a user tries to perform an operation that requires a specific
 * friend request status, but the request is in a different status (e.g., trying to accept an
...
public class InvalidFriendRequestStatusException extends FriendshipException {
  ...
  public InvalidFriendRequestStatusException(
      FriendRequest.FriendRequestStatus currentStatus,
