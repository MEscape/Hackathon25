 ...
 *
 * <p>This exception is thrown when a user tries to send a friend request to someone they have
 * already sent a request to, or when a pending request already exists between the users.
 *
