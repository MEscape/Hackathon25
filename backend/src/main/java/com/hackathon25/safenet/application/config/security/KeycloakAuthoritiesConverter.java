 ...
 *
 * <p>This component provides a centralized way to extract authorities from both
 * JWT tokens (dev) and opaque token introspection responses (prod), ensuring
 * consistent authority mapping across all environments.</p>
 *
 * <h3>Authority Mapping</h3>
 * <ul>
 *   <li><strong>Realm Roles:</strong> Extracted from 'realm_access.roles' → ROLE_*</li>
 *   <li><strong>Scopes:</strong> Extracted from 'scope' claim → SCOPE_*</li>
 * </ul>
 *
 * <h3>Usage</h3>
 * <pre>
...
public class KeycloakAuthoritiesConverter {
     ...
     * Used in development environment with JWT authentication.
     *
    ...
    /**
     * Extracts authorities from token claims map.
     * Used in production environment with opaque token introspection.
     *
     ...
     * Handles both space-separated string format and collection format.
     *
     * @param claims the token claims
