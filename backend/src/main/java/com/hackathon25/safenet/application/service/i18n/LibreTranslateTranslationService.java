...
@Slf4j
@Service
@ConditionalOnProperty(name = "translation.provider", havingValue = "libretranslate", matchIfMissing = true)
...
public class LibreTranslateTranslationService implements TranslationService {
    ...
    private String translate(String content, Language source, Language target, boolean isHtml) {
        try {
            ...
            String cacheKey = (isHtml ? "HTML" : "TEXT") + "|" + source + "->" + target + "|" + content.hashCode();
    ...
    private String callLibreTranslate(String content, Language source, Language target, boolean isHtml) {
