 ...
 *
 * <p>This configuration creates a CORS setup that allows controlled cross-origin access to the
 * SafeNet API. The configuration is designed to be secure by default while supporting legitimate
 * frontend applications and development environments.
 *
 ...
 *       support
 *   <li><strong>Exposed Headers:</strong> Location for RESTful resource creation responses
 ...
 *
 * <ul>
 *   <li>Origins are explicitly configured (no wildcard with credentials)
 *   <li>Headers are restricted to necessary authentication and content headers
 *   <li>Methods are limited to standard REST operations
 *   <li>Preflight caching reduces unnecessary OPTIONS requests
 * </ul>
 */
@Configuration
...
public class CorsSecurityConfig {
  ...
  public CorsConfigurationSource corsConfigurationSource() {
    ...
    configuration.setAllowedOrigins(
        Arrays.asList(applicationProperties.getSecurity().getCorsAllowedOrigins()));
