...
public class MeteoAlarmService implements MeteoAlarmPort {
  ...
  private MeteoAlarmItem parseItem(Element itemElement, String requestedLanguage) {
    try {
      ...
      String languageSpecificDescription =
          MeteoAlarmParser.extractLanguageSpecificDescription(description, requestedLanguage);
      return MeteoAlarmItem.builder()
          .title(title)
          .description(
              languageSpecificDescription != null ? languageSpecificDescription : description)
          .link(link)
          .guid(guid)
          .pubDate(pubDate)
          .region(title)
